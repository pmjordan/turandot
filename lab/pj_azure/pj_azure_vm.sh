...
function create {
    ...
    az vm create --resource-group $RESOURCEGROUP --name $VMNAME --image $IMAGE --size Standard_B2ms --admin-username azureuser --generate-ssh-keys --custom-data scripts/pj_cloud-init.txt
}
